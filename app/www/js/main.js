...
var ListView = /** @class */ (function () {
    ...
    ListView.prototype.getTimeSpan = function (id) {
        var when = moment(id, 'x').fromNow();
        return when;
    };
    return ListView;
}());
...
},{"./data-storage":2,"./list-view":3,"./task":6,"./task-manager":5}],5:[function(require,module,exports){
"use strict";
exports.__esModule = true;
